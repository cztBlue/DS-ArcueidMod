...
local function ConfigureRunState(inst)
    ...
    elseif inst:HasTag("groggy") then
        ...
        --这里改动了
    elseif inst.prefab == "arcueid" and inst.components.arcueidstate:IsCarefulWalking() then
...
local function GetRunStateAnim(inst)
    --活力值低于0.35触发昏沉动画
    if inst.components.vigour ~= nil and
        inst.prefab == "arcueid" and inst.components.vigour.currentvigour < 126 then
        return "idle_walk"
    end

    return (inst.sg.statemem.careful and "careful_walk")
...
local function DoYawnSound(inst)
    ...
    elseif not inst:HasTag("mime") then
        inst.SoundEmitter:PlaySound((inst.talker_path_override or "dontstarve/characters/") ..
            (inst.soundsname or inst.prefab) .. "/yawn")
    end
end
        ...
        function(inst, data)
            if not inst.components.inventory:IsItemEquipped(data.umbrella) then
                local sameTool = inst.components.inventory:FindItem(function(item)
                    return item.prefab == "umbrella" or item.prefab == "grass_umbrella" or
                        item.prefab == "palmleaf_umbrella"
                end)
                if sameTool then
...
local states =
{
    ...
    State {
        ...
        onenter = function(inst)
            ...
            inst.AnimState:PlayAnimation("meditation_loop", true)  -- 播放 idle 动画
        end,
    ...
    State {
        ...
        onenter = function(inst, pushanim)
            ...
            elseif inst.toolwantstobreak then
                ...
                local equippedArmor = inst.components.inventory and
    ...
    State {
        ...
        {
            TimeEvent(6 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/common/harvested/pool/pan") end),
            TimeEvent(14 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/common/harvested/pool/pan") end),
            TimeEvent((6 + 15) * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/common/harvested/pool/pan") end),
            TimeEvent((14 + 15) * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/common/harvested/pool/pan") end),
            TimeEvent((6 + 30) * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/common/harvested/pool/pan") end),
            TimeEvent((14 + 30) * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/common/harvested/pool/pan") end),
            TimeEvent((6 + 45) * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/common/harvested/pool/pan") end),
            TimeEvent((14 + 45) * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/common/harvested/pool/pan") end),
            TimeEvent((6 + 60) * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/common/harvested/pool/pan") end),
            TimeEvent((14 + 60) * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC003/common/harvested/pool/pan") end),
        },
...
--]]
    ...
    State {
        ...
        timeline =
        {
            ...
            TimeEvent(24 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve/common/fishingpole_baitsplash") end),
            ...
            TimeEvent(138 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve/common/fishingpole_fishcaught") end),
    ...
    State {
        ...
        timeline =
        {
            ...
            TimeEvent(23 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve/common/fishingpole_fishland") end),
    ...
    State {
        ...
        onenter = function(inst)
            inst.components.locomotor:Stop()
            local is_gear = inst:GetBufferedAction() and inst:GetBufferedAction().invobject and
                inst:GetBufferedAction().invobject.components.edible and
                inst:GetBufferedAction().invobject.components.edible.foodtype == "GEARS"
    ...
    State {
        ...
        onenter = function(inst)
            ...
            inst.AnimState:OverrideSymbol("pan_flute01", inst.sg.statemem.flute.flutebuild or "pan_flute",
                inst.sg.statemem.flute.flutesymbol or "pan_flute01")
        ...
        {
            TimeEvent(30 * FRAMES, function(inst)
                local instrument = inst.sg.statemem.flute and inst.sg.statemem.flute:IsValid() and
                    inst.sg.statemem.flute.components.instrument or nil
    ...
    State {
        ...
        onenter = function(inst)
            ...
            inst.AnimState:OverrideSymbol("horn01", inst.sg.statemem.horn.hornbuild or "horn",
                inst.sg.statemem.horn.hornsymbol or "horn01")
        ...
        {
            TimeEvent(21 * FRAMES, function(inst)
                local instrument = inst.sg.statemem.horn and inst.sg.statemem.horn:IsValid() and
                    inst.sg.statemem.horn.components.instrument or nil
    ...
    State {
        ...
        onenter = function(inst)
            ...
            inst.sg.statemem.target_position = target and
                Vector3(inst.components.combat.target.Transform:GetWorldPosition())
            inst.components.combat:StartAttack()
            inst.components.locomotor:Stop()
        ...
        timeline =
        {
            ...
            TimeEvent(12 * FRAMES, function(inst)
                ...
                if inst.components.combat:GetWeapon() and inst.components.combat:GetWeapon():HasTag("blunderbuss") then
                    ...
                    local angle
                    if inst.components.combat.target and inst.components.combat.target:IsValid() then
                        angle = (inst:GetAngleToPoint(inst.components.combat.target.Transform:GetWorldPosition()) - 90) *
                            DEGREES
                    else
                        angle = (inst:GetAngleToPoint(inst.sg.statemem.target_position.x, inst.sg.statemem.target_position.y, inst.sg.statemem.target_position.z) - 90) *
                            DEGREES
                    end
        ...
        onenter = function(inst)
            ...
            local danger = FindEntity(inst, 10, function(target)
                return (target:HasTag("monster") and not target:HasTag("player") and not inst:HasTag("spiderwhisperer"))
                    or
                    (target:HasTag("monster") and not target:HasTag("player") and inst:HasTag("spiderwhisperer") and not target:HasTag("spider"))
                    or (target:HasTag("pig") and not target:HasTag("player") and inst:HasTag("spiderwhisperer"))
                    or (target.components.combat and target.components.combat.target == inst)
            end)
    ...
    State {
        ...
        timeline =
        {
            ...
            TimeEvent(60 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve/common/rebirth_amulet_poof") end),
    ...
    State {
        ...
        onenter = function(inst)
            ...
            inst:DoTaskInTime(4.7,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve/movement/bodyfall_dirt", "bodyfall") end)
        end,
    ...
    State {
        ...
        onenter = function(inst)
            ...
            inst.components.locomotor:Stop()
            inst.SoundEmitter:PlaySound(
                "dontstarve_wagstaff/characters/wagstaff/dontstarve/characters/wagstaff/teleumbrella_end")
        end,
    ...
    State {
        ...
        timeline =
        {
            ...
            TimeEvent(10 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_wagstaff/characters/wagstaff/teleumbrella_end") end),
    ...
    State {
        ...
        {
            TimeEvent(20 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC002/common/use_spyglass") end),
        },
    ...
    State {
        ...
        timeline =
        {
            ...
            TimeEvent(105 * FRAMES,
                function(inst)
                    inst.SoundEmitter:PlaySound("dontstarve_DLC003/characters/werewilba/bark")
                end),
            TimeEvent(139 * FRAMES,
                function(inst)
    ...
    State {
        ...
        {
            TimeEvent(26 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC002/common/luxury_fan", "fan") end),
            TimeEvent(70 * FRAMES, function(inst)
                inst:PerformBufferedAction()
            end),
    ...
    State {
        ...
        onenter = function(inst, pushanim)
            ...
            if inst.wantstosneeze
                or (inst.components.poisonable and inst.components.poisonable:IsPoisoned())
    ...
    State {
        ...
        {
            TimeEvent(8 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC002/common/antivenom_whoosh") end),
    ...
    State {
        ...
        {
            TimeEvent(5 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC002/common/portal/ride_sqeak") end),
            TimeEvent(14 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC002/common/portal/ride_sqeak") end),
            TimeEvent(68 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC002/common/portal/ride_sqeak") end),
            TimeEvent(100 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC002/common/portal/ride_sqeak") end),
            TimeEvent(128 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("dontstarve_DLC002/common/portal/ride_sqeak") end),
        },
